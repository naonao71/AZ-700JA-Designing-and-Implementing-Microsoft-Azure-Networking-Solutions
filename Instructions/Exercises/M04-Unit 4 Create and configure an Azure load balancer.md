...
![図 15](../media/exercise-internal-standard-load-balancer-environment-diagram.png)
...
![図 2](../media/create-virtual-network-1.png)
...
8. **「サブネットの編集」** ウィンドウで、**「myBackendSubnet」** のサブネット名と **「10.1.0.0/24」** のサブネット アドレス範囲を指定します。
