...
3. 「**Firewall Manager**」ページで、「**セキュリティ保護付き仮想ハブの表示**」をクリックします。
...
2. 「人気のあるオファー」リストで、「**Windows Server Datacenter 2019**」を選択します。
...
2. 「**Firewall Manager**」から、「**Azure Firewall ポリシーの表示**」をクリックします。
