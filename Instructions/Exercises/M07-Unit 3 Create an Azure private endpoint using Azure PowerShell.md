...
- New-AzPrivateEndpoint
  ...
  >  **webapp-resource-group-name** および **webapp-resource-group-name** を置き換えます。
...
$webapp = Get-AzWebApp -ResourceGroupName <webapp-resource-group-name> -Name <webapp-resource-group-name>
